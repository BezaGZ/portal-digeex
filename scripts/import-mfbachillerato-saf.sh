#!/bin/bash
# ============================================================================
# Importación SAF: Modalidades Flexibles - Bachillerato
# Importa 4 módulos (1ra y 2da Etapa) a la colección Modalidades Flexibles
# ============================================================================
...
# Importar SAF
# ----------------------------------------------------------------------------
SAF_DIR="$SCRIPT_DIR/saf-mf-bachillerato"
SAF_NAME="saf-mf-bachillerato"
...
echo ""
echo "Contenido:"
echo "  - Primera Etapa Módulo I (Bachillerato)"
echo "  - Primera Etapa Módulo II (Bachillerato)"
echo "  - Segunda Etapa Módulo I (Bachillerato)"
echo "  - Segunda Etapa Módulo II (Bachillerato)"
echo ""
