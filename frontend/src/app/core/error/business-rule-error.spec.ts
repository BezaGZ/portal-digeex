...
/**
 * Tests de BusinessRuleError, clase de error de dominio del portal.
 * Reemplaza el patrón `{ success: false, error: 'texto' }`.
 *
...
describe('BusinessRuleError', () => {
  ...
  it('should expose the message passed in the constructor', () => {
    const err = new BusinessRuleError('LAST_SUPERADMIN', 'Ya existen 2 superadmins activos');
