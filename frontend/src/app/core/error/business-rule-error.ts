/**
 * Códigos tipados de las reglas de negocio del portal. Se listan acá para
 * que el consumidor (componentes, toasts, i18n) pueda hacer un switch
 * exhaustivo sobre el motivo del error sin depender del texto del mensaje,
 ...
 * y los handlers globales lo traten como error nativo, y expone un `code`
 * tipado para que el consumidor mapee a toast sin parsear texto.
 */
